...
class ChatService:
    ...
    @staticmethod
    def get_user_conversations(db: Session, user_id: str, skip: int = 0, limit: int = 20) -> List[Dict[str, Any]]:
        """Get all conversations for a user"""
        conversations = ConversationRepository.get_conversations_by_user_id(db, user_id, skip, limit)
    ...
    @staticmethod
    def add_user_message(db: Session, conversation_id: int, content: str) -> Dict[str, Any]:
    ...
    @staticmethod
    def add_assistant_message(db: Session, conversation_id: int, content: str, 
                             tool_calls: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    @staticmethod
    def add_tool_result(db: Session, message_id: int, tool_results: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    def generate_response(db: Session, conversation_id: int, query: str) -> Dict[str, Any]:
        """
